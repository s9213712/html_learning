...
AI_AGENT_TOOL_BLUEPRINT.update({
    "write_chat_create_room": {"label": "建立聊天室", "description": "root 專用白名單工具：建立站內聊天室。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_join_room": {"label": "加入聊天室", "description": "root 專用白名單工具：加入指定聊天室。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_invite": {"label": "邀請聊天室成員", "description": "root 專用白名單工具：邀請會員加入聊天室。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_send_message": {"label": "送出聊天室訊息", "description": "root 專用白名單工具：在聊天室送出訊息。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_edit_message": {"label": "編輯聊天室訊息", "description": "root 專用白名單工具：編輯聊天室訊息。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_delete_message": {"label": "刪除聊天室訊息", "description": "root 專用白名單工具：刪除聊天室訊息。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_friend_request": {"label": "送出好友邀請", "description": "root 專用白名單工具：送出好友邀請。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_chat_friend_decide": {"label": "處理好友邀請", "description": "root 專用白名單工具：接受或拒絕好友邀請。", "min_role": "super_admin", "data_scope": "write_tool:chat"},
    "write_appeal_create": {"label": "建立申訴", "description": "root 專用白名單工具：提交站內申訴。", "min_role": "super_admin", "data_scope": "write_tool:appeals"},
    "write_appeal_review": {"label": "審核申訴", "description": "root 專用白名單工具：審核站內申訴。", "min_role": "super_admin", "data_scope": "write_tool:appeals"},
    "write_notification_send": {"label": "發送站內通知", "description": "root 專用白名單工具：發送站內通知。", "min_role": "super_admin", "data_scope": "write_tool:notifications"},
    "write_report_claim": {"label": "認領檢舉案件", "description": "root 專用白名單工具：認領檢舉案件。", "min_role": "super_admin", "data_scope": "write_tool:reports"},
    "write_report_resolve": {"label": "結案檢舉案件", "description": "root 專用白名單工具：結案檢舉案件。", "min_role": "super_admin", "data_scope": "write_tool:reports"},
    "write_user_review_registration": {"label": "審核會員註冊", "description": "root 專用白名單工具：審核會員註冊。", "min_role": "super_admin", "data_scope": "write_tool:members"},
    "write_user_block": {"label": "封鎖或解除會員", "description": "root 專用白名單工具：封鎖或解除會員限制。", "min_role": "super_admin", "data_scope": "write_tool:members"},
    "write_user_add_violation": {"label": "新增會員違規", "description": "root 專用白名單工具：新增會員違規紀錄。", "min_role": "super_admin", "data_scope": "write_tool:members"},
    "write_user_reset_violations": {"label": "重置會員違規", "description": "root 專用白名單工具：重置會員違規紀錄。", "min_role": "super_admin", "data_scope": "write_tool:members"},
    "write_moderation_note": {"label": "新增會員管理備註", "description": "root 專用白名單工具：新增會員管理備註。", "min_role": "super_admin", "data_scope": "write_tool:moderation"},
    "write_moderation_proposal_create": {"label": "建立治理處分提案", "description": "root 專用白名單工具：建立會員治理處分提案。", "min_role": "super_admin", "data_scope": "write_tool:moderation"},
    "write_moderation_proposal_vote": {"label": "投票治理處分提案", "description": "root 專用白名單工具：對會員治理提案投票。", "min_role": "super_admin", "data_scope": "write_tool:moderation"},
    "write_moderation_proposal_execute": {"label": "執行治理處分提案", "description": "root 專用白名單工具：執行會員治理提案。", "min_role": "super_admin", "data_scope": "write_tool:moderation"},
    "write_moderation_proposal_override": {"label": "root 覆寫治理提案", "description": "root 專用白名單工具：覆寫會員治理提案。", "min_role": "super_admin", "data_scope": "write_tool:moderation"},
    "write_storage_quota_override": {"label": "設定雲端容量覆寫", "description": "root 專用白名單工具：設定雲端容量覆寫。", "min_role": "super_admin", "data_scope": "write_tool:storage"},
    "write_storage_quota_override_clear": {"label": "清除雲端容量覆寫", "description": "root 專用白名單工具：清除雲端容量覆寫。", "min_role": "super_admin", "data_scope": "write_tool:storage"},
    "write_storage_sync_quota": {"label": "同步雲端容量", "description": "root 專用白名單工具：同步雲端容量。", "min_role": "super_admin", "data_scope": "write_tool:storage"},
    "write_storage_trash_purge": {"label": "清理雲端垃圾桶", "description": "root 專用白名單工具：清理雲端垃圾桶。", "min_role": "super_admin", "data_scope": "write_tool:storage"},
    "write_storage_maintenance": {"label": "執行雲端維護", "description": "root 專用白名單工具：執行雲端維護。", "min_role": "super_admin", "data_scope": "write_tool:storage"},
    "write_cloud_drive_text_update": {"label": "更新雲端文字檔", "description": "root 專用白名單工具：更新雲端文字檔。", "min_role": "super_admin", "data_scope": "write_tool:cloud_drive"},
    "write_comfyui_start": {"label": "啟動 ComfyUI 連線", "description": "root 專用白名單工具：啟動或切換 ComfyUI 連線。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_stop": {"label": "停止 ComfyUI", "description": "root 專用白名單工具：停止 ComfyUI 後端流程。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_interrupt": {"label": "中斷 ComfyUI 任務", "description": "root 專用白名單工具：中斷 ComfyUI 任務。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_save_image": {"label": "保存 ComfyUI 圖片", "description": "root 專用白名單工具：保存 ComfyUI 產圖。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_share_image": {"label": "分享 ComfyUI 圖片", "description": "root 專用白名單工具：分享 ComfyUI 產圖。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_favorite_image": {"label": "收藏 ComfyUI 圖片", "description": "root 專用白名單工具：收藏 ComfyUI 圖片。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_delete_favorite": {"label": "刪除 ComfyUI 收藏", "description": "root 專用白名單工具：刪除 ComfyUI 收藏。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_workflow_run": {"label": "執行 ComfyUI workflow", "description": "root 專用白名單工具：執行 ComfyUI workflow。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_workflow_import": {"label": "匯入 ComfyUI workflow", "description": "root 專用白名單工具：匯入 ComfyUI workflow。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_workflow_update": {"label": "更新 ComfyUI workflow", "description": "root 專用白名單工具：更新 ComfyUI workflow。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_workflow_delete": {"label": "刪除 ComfyUI workflow", "description": "root 專用白名單工具：刪除 ComfyUI workflow。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_civitai_inspect": {"label": "檢查 Civitai 模型", "description": "root 專用白名單工具：檢查 Civitai 模型資訊。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_civitai_search": {"label": "搜尋 Civitai 模型", "description": "root 專用白名單工具：搜尋 Civitai 模型。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_comfyui_civitai_download": {"label": "下載 Civitai 模型", "description": "root 專用白名單工具：下載 Civitai 模型。", "min_role": "super_admin", "data_scope": "write_tool:comfyui"},
    "write_security_test_pentest": {"label": "執行安全滲透測試", "description": "root 專用白名單工具：執行站內安全滲透測試。", "min_role": "super_admin", "data_scope": "write_tool:security"},
    "write_security_test_functional": {"label": "執行功能安全測試", "description": "root 專用白名單工具：執行功能安全測試。", "min_role": "super_admin", "data_scope": "write_tool:security"},
    "write_security_test_privilege": {"label": "執行權限安全測試", "description": "root 專用白名單工具：執行權限安全測試。", "min_role": "super_admin", "data_scope": "write_tool:security"},
...
AI_AGENT_TOOL_ARGUMENT_HINTS.update({
    "write_chat_create_room": "canonical args: name,target_user,allow_anonymous,anonymous,anonymous_enabled,join_password,invite_usernames；把 room_name/title 轉成 name，把 password 轉成 join_password。",
    "write_chat_invite": "canonical args: room_id,username,usernames；單一邀請用 username，多位邀請用 usernames 陣列。",
    "write_chat_send_message": "canonical args: room_id,content,attachments,reply_to_message_id；把 message/text 轉成 content。",
    "write_chat_friend_request": "canonical args: username,target_user_id,message；把 target_username/friend_username 轉成 username。",
    "write_chat_friend_decide": "canonical args: request_id,decision,reason；decision 只能是 accept/approve 或 reject/deny 對應的站內值。",
    "write_appeal_create": "canonical args: subject,content,appeal_type,target_type,target_id,evidence；把 message/body 轉成 content。",
    "write_appeal_review": "canonical args: appeal_id,action,note,reward_points；action 只能是 approve 或 reject，把 decision 轉成 action，把 review_note 轉成 note。",
    "write_notification_send": "canonical args: user_id,user_ids,title,body,type,link；把 message/content 轉成 body。",
    "write_report_resolve": "canonical args: report_id,resolution,review_note,action,reward_points。",
    "write_user_review_registration": "canonical args: user_id,decision,review_note。",
    "write_user_block": "canonical args: user_id,blocked,duration_minutes,reason；封鎖 blocked=true，解除 blocked=false。",
    ...
    "write_storage_maintenance": "canonical args: action,dry_run,reason。",
    "write_cloud_drive_text_update": "canonical args: file_id,content；把 text/body 轉成 content。",
    "write_comfyui_start": "canonical args: backend_url,mode,reason；遠端模式 mode=remote，站內啟動 mode=local。",
    "write_comfyui_stop": "canonical args: reason。",
    "write_comfyui_interrupt": "canonical args: reason。",
    "write_comfyui_save_image": "canonical args: job_id,history_id,filename,target_folder。",
    "write_comfyui_share_image": "canonical args: job_id,history_id,filename,scope,share_password,expires_at。",
    "write_comfyui_favorite_image": "canonical args: image_ref,job_id,history_id,filename,note,tags。",
    "write_comfyui_workflow_run": "canonical args: preset_id,inputs,parameters,confirm_billing。",
    "write_comfyui_workflow_import": "canonical args: name,description,workflow,layout,metadata。",
    "write_comfyui_civitai_search": "canonical args: query,model_type,limit,nsfw。",
    "write_comfyui_civitai_download": "canonical args: url,download_url,model_id,version_id,target_type,filename。",
    "write_security_test_pentest": "canonical args: target,profile,tool_timeout_seconds,reason；只能執行站內安全測試端點。",
    "write_security_test_functional": "canonical args: profile,tool_timeout_seconds,reason。",
    "write_security_test_privilege": "canonical args: profile,tool_timeout_seconds,reason。",
    "write_security_test_stress": "canonical args: profile,concurrency,duration_seconds,tool_timeout_seconds,reason；避免要求無限制壓測。",
})
