...
from services.ai_agent.hermes import (
    ...
    DEFAULT_AI_AGENT_OPERATION_MODE,
    AI_AGENT_AUDIT_INTERVAL_MINUTES_DEFAULT,
    AI_AGENT_AUDIT_CPU_PERCENT_THRESHOLD_DEFAULT,
    AI_AGENT_AUDIT_RAM_PERCENT_THRESHOLD_DEFAULT,
    AI_AGENT_AUDIT_DISK_PERCENT_THRESHOLD_DEFAULT,
    AI_AGENT_AUDIT_IP_EVENT_RATE_THRESHOLD_DEFAULT,
    AI_AGENT_AUDIT_IP_EVENT_RATE_WINDOW_MINUTES_DEFAULT,
    AI_AGENT_AUDIT_SECURITY_EVENT_RATE_THRESHOLD_DEFAULT,
    AI_AGENT_AUDIT_SECURITY_EVENT_RATE_WINDOW_MINUTES_DEFAULT,
    AI_AGENT_AUDIT_AUTO_BLOCK_DEFAULT,
    AI_AGENT_AUDIT_BLOCK_MINUTES_DEFAULT,
    AI_AGENT_AUDIT_NOTIFY_ROOT_DEFAULT,
)
...
DEFAULT_SETTINGS = {
    ...
    **COMFYUI_DEFAULT_SETTINGS,
    ...
    "ai_agent_audit_ip_event_rate_threshold": AI_AGENT_AUDIT_IP_EVENT_RATE_THRESHOLD_DEFAULT,
    "ai_agent_audit_ip_event_rate_window_minutes": AI_AGENT_AUDIT_IP_EVENT_RATE_WINDOW_MINUTES_DEFAULT,
    "ai_agent_audit_security_event_rate_threshold": AI_AGENT_AUDIT_SECURITY_EVENT_RATE_THRESHOLD_DEFAULT,
    "ai_agent_audit_security_event_rate_window_minutes": AI_AGENT_AUDIT_SECURITY_EVENT_RATE_WINDOW_MINUTES_DEFAULT,
    "ai_agent_audit_auto_block_suspect_ip": AI_AGENT_AUDIT_AUTO_BLOCK_DEFAULT,
    "ai_agent_audit_block_minutes": AI_AGENT_AUDIT_BLOCK_MINUTES_DEFAULT,
    "ai_agent_audit_notify_root": AI_AGENT_AUDIT_NOTIFY_ROOT_DEFAULT,
    "ai_agent_persona": "concise_helper",
